...
test('purchase a product on desktop', async ({ page }) => {
  ...
  await expect(page.getByText('$').nth(1)).toHaveText('$3,499.75')
  ...
  await expect(page.getByText('$').nth(1)).toHaveText('$6,999.50')
  ...
  await expect(page.getByText('$').nth(1)).toHaveText('$10,499.25')
